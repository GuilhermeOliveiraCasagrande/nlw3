...
/* 
  ScrollView horizontal -> Deixa um conteúdo scrollável horizontalmente (esquerda, direita)
  ScrollView vertical -> Deixa um conteúdo scrollável verticalmente (cima, baixo)
  ScrollView pagingEnabled -> Não deixa ficar no meio (pág. 1 -> 2, não 1 -> 1.5 -> 2)
*/
